...
export const api = {
  ...
  fetchByCountryName(name: string): Promise<DetailsCountryType[]> {
    return instance.get(`name/${name}?fields=flags,name,altSpellings,population,region,subregion,capital,tld,currencies,languages,borders`);
  },
